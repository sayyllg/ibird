...
Ibird.Dialog = BootstrapDialog;
  
Ibird.Dialog.confirm = function(message, callback) {
...
Ibird.Dialog.alert = function(message, callback) {
  return new BootstrapDialog({
      title: '警告',
      message: message,
      cssClass:'confirm-dialog',
...
Ibird.Dialog.configDefaultOptions({
	title: '提示：',
	closeByBackdrop: false,
});

Ibird.Controller = Marionette.Controller.extend({
